...
The following tutorial loosely follows the Project EDDIE steps with the exception of using the built-in `run_example_sim` in the `glmtools` package to complete the initial set-up and file handling. The streamlines setup and avoids manual interaction with system files.
